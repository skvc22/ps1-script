...
class getPS1catclass:
    ...
    def add_options(self, parser=None, usage=None):
        ...
        parser.add_argument('--cathtml'  , default='http://faun.rc.fas.harvard.edu/eschlafly/wise/fitscat_qy', type=str,
        ...
        parser.add_argument('--cat_dir', default='/projects/caps/uiucsn/PS1SKYMAPPER_fitscat_qy/fitscat_qy',
        ...
        parser.add_argument('-y',  default=False, action="store_true",
                          help='y band')
        parser.add_argument('--sexagesimal',  default=False, action="store_true",
        ...
        parser.add_argument('--requiregriz',  default=False, action="store_true",
        ...
        parser.add_argument('--skipsave',  default=False, action="store_true",
                          help='Don\'t save the catalog')
        parser.add_argument('--Mmax'  , default=None , type=float,
                          help='cut all objects with M<Mmin for specified filters (default=%default)')
        parser.add_argument('--Mmin'  , default=None , type=float,
                          help='cut all objects with M>Mmax for specified filters (default=%default)')
        parser.add_argument('--dMmax'  , default=None , type=float,
                          help='cut all objects with dM<dMmin for specified filters (default=%default)')
        parser.add_argument('--dMmin'  , default=None , type=float,
                          help='cut all objects with dM>dMmax for specified filters (default=%default)')
        parser.add_argument('--decam'  , default=False , action="store_true",
                          help='convert the PS1 mag to DECAM(DES)')
        parser.add_argument('--megacam'  , default=False , action="store_true",
                          help='convert the PS1 mag to MEGACAM(SNLS)')
        parser.add_argument('--swope'  , default=False , action="store_true",
                          help='convert the PS1 mag to SWOPE(CSP)')
        parser.add_argument('--transfdir'  , default=False , type=str,
                          help='path to the PS1transformations dir (default=%default)')
        parser.add_argument('--skip_sc'  , default=False ,action="store_true",
...
if __name__=='__main__':
    ...
    getPS1cat.options = parser.parse_args(args=sys.argv[3:])
    args = sys.argv[1:3]
